...
class ProposalCreator:
    ...
    def __call__(self, loc, score,
        ...
        keep = np.where(torch.ge(torch.from_numpy(hs), min_size) & torch.ge(torch.from_numpy(ws), min_size))[0]
        #keep = np.where((hs >= min_size.numpy()) & (ws >= min_size.numpy()))[0] #num.ndarray不能与tensor比较
